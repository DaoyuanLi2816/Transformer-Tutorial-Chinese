...
labelbank pins ``transformers`` without an upper bound, so a fresh install
may resolve either the 4.x or the 5.x line. These helpers keep the call
sites working (and quiet) on both.
"""
